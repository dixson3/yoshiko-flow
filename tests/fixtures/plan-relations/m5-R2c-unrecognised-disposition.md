...
| #125 | status-enum hardening for `update-status` | incldue | The documented 9-value vocabulary becomes a linted enum rather than doc/spec/test-enforced only. | Issue 2.5 |
