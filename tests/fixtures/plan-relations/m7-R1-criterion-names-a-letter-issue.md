...
| :-- | :-- | :-- | :-- |
| SC0 | The free-id list is published before any `REQ-DATA-*` id is written | `assets/req-data-ids.txt` exists and its `free` set contains every id Epic 0 allocates; the issue has no predecessors | Z.9 |
