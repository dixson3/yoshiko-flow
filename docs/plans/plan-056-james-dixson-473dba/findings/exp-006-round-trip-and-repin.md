...
description: Only 32 of 1563 okf-lint findings are the genuine disagreement, and all 32 flip on root framing — which OKF v0.2 is silent on. The write half cannot be tested.
---
...
**measured:** — only 32 of 1563 findings are the genuine disagreement. Full categorisation (sums to
1563): 1169 broken links (**mostly noise** — placeholder link text like `relative-url-1`, plus the two
