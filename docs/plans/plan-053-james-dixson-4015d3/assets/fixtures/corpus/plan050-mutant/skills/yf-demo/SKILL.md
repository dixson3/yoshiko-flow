...
## 9. THE MUTATION — plan-050 Issue 7.3's original bug, re-inserted verbatim

This is the only difference between this tree and `fp-clean/`. It is the defect plan-050
fixed by hand without closing the class; re-inserting it is what proves the check would have
caught the first instance, which is the whole argument for D-3.
