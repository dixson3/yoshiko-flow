...
type: Reference
okf_spec: OKF-PLAN
description: 'Upstream issue #376 - check_web_counts: group membership is NOT CHECKED
  where a bullet enumerates no member ids (declared limit)'
---
# Upstream #376: check_web_counts: group membership is NOT CHECKED where a bullet enumerates no member ids (declared limit)

- **Number:** 376
- **Title:** check_web_counts: group membership is NOT CHECKED where a bullet enumerates no member ids (declared limit)
- **URL:** 
- **State:** OPEN
- **Labels:** 
