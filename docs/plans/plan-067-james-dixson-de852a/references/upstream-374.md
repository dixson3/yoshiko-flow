...
type: Reference
okf_spec: OKF-PLAN
description: 'Upstream issue #374 - web/plugins/skill_pages.py: the authored-page
  guard is EXISTENCE-ONLY — a zero-byte page passes it and builds green'
---
# Upstream #374: web/plugins/skill_pages.py: the authored-page guard is EXISTENCE-ONLY — a zero-byte page passes it and builds green

- **Number:** 374
- **Title:** web/plugins/skill_pages.py: the authored-page guard is EXISTENCE-ONLY — a zero-byte page passes it and builds green
- **URL:** 
- **State:** OPEN
- **Labels:** 
