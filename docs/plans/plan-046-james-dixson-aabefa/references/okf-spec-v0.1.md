...
type: Reference
okf_spec: OKF-PLAN
id: okf-spec-v0.1-upstream
retrieved: '2026-08-18'
source: https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/ee67a5ca/okf/SPEC.md
---

# Reference: Open Knowledge Format (OKF) SPEC v0.1 — verbatim upstream copy

> Fetched 2026-08-18 from `GoogleCloudPlatform/knowledge-catalog` at commit `ee67a5ca`
> (2026-06-12, *"Import Open Knowledge Format reference enrichment agent (#28)"*) via `gh api`,
> the last revision of `okf/SPEC.md` before `780fe9d3` (2026-07-24) migrated the path to v0.2.
> Vendored so a cold reader can verify every v0.1 claim — and every v0.1→v0.2 delta — without
> network access.
>
> **This closes plan-046 risk R1.** Before this file, v0.1's §1/§2/§6/§7 bodies were never quoted
> in-repo, so further undeclared v0.2 changes could not be ruled out. They can now be diffed.
