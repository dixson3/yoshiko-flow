...
type: Reference
okf_spec: OKF-PLAN
id: okf-spec-v0.2-upstream
retrieved: '2026-08-18'
source: https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md
---

# Reference: Open Knowledge Format (OKF) SPEC v0.2 — verbatim upstream copy

> Fetched 2026-08-18 from `GoogleCloudPlatform/knowledge-catalog` @ `main` via `gh api`.
> Vendored into this bundle so a cold reader can verify every v0.2 claim without network access.
