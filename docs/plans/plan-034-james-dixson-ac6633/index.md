...
# plan-034-james-dixson-ac6633

> Post-plan-033 follow-ups: per-harness settings-drift axis (yf-252c) + codex project_doc_max_bytes block-size-budget check (yf-297v) + web/ documentation buildout — managed-files reference reconciled with harness-tune.md (yf-pxet), beads & yf-beads-* concepts (yf-rd33), yf-plan/yf-research subagent+workflow docs (yf-7ntv), workflow-vocabulary glossary (yf-3d13)
