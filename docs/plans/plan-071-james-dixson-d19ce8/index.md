...
- [reviews/pass-5.md](reviews/pass-5.md) - [red-team pass 5, EXECUTION, post-approval re-scope] APPROVE — the plan-070 deferral delta is confined to its declared surface (35 lines, 11 hunks); every re-scope premise measured true; suite green; 3 low notes
- [findings/fidelity-baseline.md](findings/fidelity-baseline.md) - Fidelity baseline over plans 060–070 (plan-071 Issue 1.3): 5 of 8 intaken plans flipped a Success Criterion after approval (14 flips: 9 added, 2 amended, 8 FALSE at landing); halts post-L6 are `no-record` for every bundle because the `landing-halt:` bullet postdates them; 4 plans FAIL and 3 are INCONCLUSIVE under `recheck-criteria --timeout 10`
...
- [reviews/pass-6.md](reviews/pass-6.md) - [red-team pass 6, EXECUTION, post-execution recertification] APPROVE — zero measured findings; the executed bundle differs from the approved fingerprint solely by the SC4 row (ESC-001); all 20 clause criteria hold; freeze check passes with 5 negative controls
