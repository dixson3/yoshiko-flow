...
type: Reference
okf_spec: OKF-PLAN
description: 'Upstream issue #204 - yf-herdr: no teardown contract — a completed plan''s
  subordinate tab is never closed, and only harvest-before-prune makes closing safe'
---
