...
type: Reference
okf_spec: OKF-PLAN
description: 'Upstream issue #270 - yf-plan: plan-review.formula.toml has NEVER been
  poured — the only structural mid-burn review gate in yf has not fired in 27 review
  passes'
---
