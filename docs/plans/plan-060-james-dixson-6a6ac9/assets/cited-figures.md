...
**`close-chain-steps` is likewise PINNED by plan-071** to this plan's landing commit: plan-071 Issue 4.3 removed two advisory steps from the chain, and a live count would report that subtraction as drift of a figure quoted as of this landing.
