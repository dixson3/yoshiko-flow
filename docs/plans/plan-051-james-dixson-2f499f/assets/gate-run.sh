#!/usr/bin/env bash
# gate-run.sh — plan-051 Issue 0.2 (adopted verbatim from plan-050 Issue 0.2, itself from plan-049 Issue 0.7). The 0/1/2 exit-discipline wrapper for a capability gate.
#
