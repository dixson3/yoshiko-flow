# plan-014-james-dixson-916de2

> Build yf-change-validation: self-maintaining per-repo change-set validation engine + manifest + triggers, on a shared PEP 723 package
