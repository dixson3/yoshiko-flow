...
<!-- snapshot: host=d3-mbp-m5.local date=2026-04-05 -->

- `bd`: bd version 0.62.0 (dev)
- `git`: git version 2.50.1 (Apple Git-155)
- `uv`: uv 0.11.2 (Homebrew 2026-03-26 aarch64-apple-darwin)
...
- Plan directory: `docs/plans/plan-001-james-dixson-c88e7a`
