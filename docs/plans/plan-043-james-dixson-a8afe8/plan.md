...
| :-- | :-- | :-- | :-- | :-- |
| [#148](https://github.com/dixson3/yoshiko-flow/issues/148) | **plan-043 execution tracking** (the coarse tracker) | tracker | Filed at intake per the `AGENTS.md` one-issue-per-plan-scale-effort convention. Stamped onto the epic as `external_ref` at pour so `upstream.py closable` can see it. | — |
