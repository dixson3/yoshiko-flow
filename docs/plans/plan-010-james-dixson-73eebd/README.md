# plan-010-james-dixson-73eebd

> Rename all skills to yf- prefix and build a Rust 'yflow' CLI to manage skill install/upgrade lifecycle, distributed via homebrew, replacing install.{sh,py}
