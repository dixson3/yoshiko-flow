...
- [upstream-triage.md](upstream-triage.md) - The candidate pool from the automated scan (48 issues). The **14 rows this plan acts on** carry a disposition and reasoning mirrored from plan.md's Upstream Issues table, which is authoritative; the remaining rows are unscored candidates and are deliberately blank.
