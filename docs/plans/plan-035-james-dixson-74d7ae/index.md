...
# plan-035-james-dixson-74d7ae

> Rework and expand the web/ documentation set for accuracy, voice, and completeness (beads/upstream workflow, formulas concept, VOICE.md + density reduction, phase-model validation + diagrams, harness-agnostic plan-mode framing + framework survey, .yf/ artifact-management reconciliation)
