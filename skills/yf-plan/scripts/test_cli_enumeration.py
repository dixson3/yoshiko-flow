...
# plan-071 Issue 4.1: `test_index_add_verb` retired with the verb (REQ-PLAN-081(c) as amended;
# REQ-PLAN-086). Index maintenance is reachable through `okf.py reindex --write`.
